...
<head>
	<title>Fale Conosco - Start_Jobs</title>
	<meta charset="utf-8" />
				...
				<section>
					...
					<div class="mini-posts">
						...
						<article>
							...
							<p>Realize pequenas tarefas e Claims de 30 em 30 minutos e ganhe coins e troque por
								criptomoedas, pagamos diretamente na sua carteira/wallet.</p>
						</article>
						<article>
							<a href="https://g1.globo.com/" class="image"><img src="images/G1.jpg"
									alt="Maior portal de notícias do Brasil" /></a>
							<p>Últimas notícias do Brasil e do mundo, sobre política, economia, emprego, educação,
								saúde, meio ambiente, tecnologia, ciência, cultura e carros.</p>
						</article>
					</div>
					<!-- 		<ul class="actions">
				...
				<section>
					...
					<ul class="contact">
						<li class="icon solid fa-envelope"><a
								href=mailto:penha@sp.senac.br?subject="link HTML">penha@sp.senac.br</a></li>
						<li class="icon solid fa-phone">(011) 2135-0300</li>
						<li class="icon solid fa-home">R. Francisco Coimbra, 403 - Penha de França, São Paulo - SP,
							03639-000
						</li>
					</ul>
				</section>
