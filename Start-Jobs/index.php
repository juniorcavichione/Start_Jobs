							...
							<!-- Banner -->
								<section id="banner">
									<div class="content">
										...
										<p>Procurando por uma vaga de emprego, você está no local certo, temos vagas em diversos segmentos.		</p>	
										<p>Aqui você encontra vagas na área de:</p>
										<ul>
										...
										<ul class="actions">
											<li><a href="vagas.html" class="button big">Página de Vagas</a></li>
										</ul>
									</div>
									<span class="image object">
										<img src="images/pic10.jpg" alt="" />
